...
public class OtherKnowledgeFilterAdapter extends BaseAdapter {
    ...
    public OtherKnowledgeFilterAdapter(int kindPosition, List<KnowledgeKindObject> list, Context context) {
