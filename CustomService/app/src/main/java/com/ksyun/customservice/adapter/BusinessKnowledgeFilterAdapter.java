...
public class BusinessKnowledgeFilterAdapter extends BaseAdapter {
    ...
    public BusinessKnowledgeFilterAdapter(int kindPosition, List<KnowledgeKindObject> list, Context context) {
