...
public class RecordKnowledgeFilterAdapter extends BaseAdapter {
    ...
    public RecordKnowledgeFilterAdapter(int kindPosition, List<KnowledgeKindObject> list, Context context) {
